...
protected:
  ...
  vector<float> mus_gfit_ndof_float_;
  TBranch *mus_gfit_ndof_float_branch;
  bool mus_gfit_ndof_float_isLoaded;
  ...
  vector<float> ak8jets_deep_bindisc_w_;
  TBranch *ak8jets_deep_bindisc_w_branch;
  bool ak8jets_deep_bindisc_w_isLoaded;
  vector<float> ak8jets_deep_bindisc_z_;
  TBranch *ak8jets_deep_bindisc_z_branch;
  bool ak8jets_deep_bindisc_z_isLoaded;
  vector<float> ak8jets_deep_bindisc_zbb_;
  TBranch *ak8jets_deep_bindisc_zbb_branch;
  bool ak8jets_deep_bindisc_zbb_isLoaded;
  vector<float> ak8jets_deep_bindisc_hbb_;
  TBranch *ak8jets_deep_bindisc_hbb_branch;
  bool ak8jets_deep_bindisc_hbb_isLoaded;
  vector<float> ak8jets_deep_bindisc_h4q_;
  TBranch *ak8jets_deep_bindisc_h4q_branch;
  bool ak8jets_deep_bindisc_h4q_isLoaded;
  ...
  vector<bool> isotracks_isLostTrack_;
  TBranch *isotracks_isLostTrack_branch;
  bool     isotracks_isLostTrack_isLoaded;
  vector<bool> isotracks_lepOverlap_;
  TBranch *isotracks_lepOverlap_branch;
  bool     isotracks_lepOverlap_isLoaded;
  vector<float> isotracks_pfNeutralSum_;
  TBranch *isotracks_pfNeutralSum_branch;
  bool     isotracks_pfNeutralSum_isLoaded;
  ...
  vector<int> isotracks_HitSignature_;
  TBranch *isotracks_HitSignature_branch;
  bool     isotracks_HitSignature_isLoaded;
  vector<int> isotracks_nearestPF_id_;
  TBranch *isotracks_nearestPF_id_branch;
  bool     isotracks_nearestPF_id_isLoaded;
  vector<float> isotracks_nearestPF_pt_;
  TBranch *isotracks_nearestPF_pt_branch;
  bool     isotracks_nearestPF_pt_isLoaded;
  vector<float> isotracks_nearestPF_DR_;
  TBranch *isotracks_nearestPF_DR_branch;
  bool     isotracks_nearestPF_DR_isLoaded;
  ...
  vector<vector<unsigned int> > isotracks_crossedEcalStatus_;
  TBranch *isotracks_crossedEcalStatus_branch;
  bool     isotracks_crossedEcalStatus_isLoaded;
  ...
  float genHEPMCweight_;
  TBranch *genHEPMCweight_branch;
  bool genHEPMCweight_isLoaded;
  float genHEPMCweight_2016_;
  TBranch *genHEPMCweight_2016_branch;
  bool genHEPMCweight_2016_isLoaded;
  float gen_LHEweight_QCDscale_muR1_muF1_;
  TBranch *gen_LHEweight_QCDscale_muR1_muF1_branch;
  bool gen_LHEweight_QCDscale_muR1_muF1_isLoaded;
  float gen_LHEweight_QCDscale_muR1_muF2_;
  TBranch *gen_LHEweight_QCDscale_muR1_muF2_branch;
  bool gen_LHEweight_QCDscale_muR1_muF2_isLoaded;
  float gen_LHEweight_QCDscale_muR1_muF0p5_;
  TBranch *gen_LHEweight_QCDscale_muR1_muF0p5_branch;
  bool gen_LHEweight_QCDscale_muR1_muF0p5_isLoaded;
  float gen_LHEweight_QCDscale_muR2_muF1_;
  TBranch *gen_LHEweight_QCDscale_muR2_muF1_branch;
  bool gen_LHEweight_QCDscale_muR2_muF1_isLoaded;
  float gen_LHEweight_QCDscale_muR2_muF2_;
  TBranch *gen_LHEweight_QCDscale_muR2_muF2_branch;
  bool gen_LHEweight_QCDscale_muR2_muF2_isLoaded;
  float gen_LHEweight_QCDscale_muR2_muF0p5_;
  TBranch *gen_LHEweight_QCDscale_muR2_muF0p5_branch;
  bool gen_LHEweight_QCDscale_muR2_muF0p5_isLoaded;
  float gen_LHEweight_QCDscale_muR0p5_muF1_;
  TBranch *gen_LHEweight_QCDscale_muR0p5_muF1_branch;
  bool gen_LHEweight_QCDscale_muR0p5_muF1_isLoaded;
  float gen_LHEweight_QCDscale_muR0p5_muF2_;
  TBranch *gen_LHEweight_QCDscale_muR0p5_muF2_branch;
  bool gen_LHEweight_QCDscale_muR0p5_muF2_isLoaded;
  float gen_LHEweight_QCDscale_muR0p5_muF0p5_;
  TBranch *gen_LHEweight_QCDscale_muR0p5_muF0p5_branch;
  bool gen_LHEweight_QCDscale_muR0p5_muF0p5_isLoaded;
  float gen_LHEweight_PDFVariation_Up_;
  TBranch *gen_LHEweight_PDFVariation_Up_branch;
  bool gen_LHEweight_PDFVariation_Up_isLoaded;
  float gen_LHEweight_PDFVariation_Dn_;
  TBranch *gen_LHEweight_PDFVariation_Dn_branch;
  bool gen_LHEweight_PDFVariation_Dn_isLoaded;
  float gen_LHEweight_AsMZ_Up_;
  TBranch *gen_LHEweight_AsMZ_Up_branch;
  bool gen_LHEweight_AsMZ_Up_isLoaded;
  float gen_LHEweight_AsMZ_Dn_;
  TBranch *gen_LHEweight_AsMZ_Dn_branch;
  bool gen_LHEweight_AsMZ_Dn_isLoaded;
  float gen_LHEweight_PDFVariation_Up_2016_;
  TBranch *gen_LHEweight_PDFVariation_Up_2016_branch;
  bool gen_LHEweight_PDFVariation_Up_2016_isLoaded;
  float gen_LHEweight_PDFVariation_Dn_2016_;
  TBranch *gen_LHEweight_PDFVariation_Dn_2016_branch;
  bool gen_LHEweight_PDFVariation_Dn_2016_isLoaded;
  float gen_LHEweight_AsMZ_Up_2016_;
  TBranch *gen_LHEweight_AsMZ_Up_2016_branch;
  bool gen_LHEweight_AsMZ_Up_2016_isLoaded;
  float gen_LHEweight_AsMZ_Dn_2016_;
  TBranch *gen_LHEweight_AsMZ_Dn_2016_branch;
  bool gen_LHEweight_AsMZ_Dn_2016_isLoaded;
  ...
  vector<float> mus_miniRelIso_all_;
  TBranch *mus_miniRelIso_all_branch;
  bool mus_miniRelIso_all_isLoaded;
  vector<float> els_miniRelIso_chg_;
  TBranch *els_miniRelIso_chg_branch;
  bool els_miniRelIso_chg_isLoaded;
  vector<float> els_miniRelIso_all_;
  TBranch *els_miniRelIso_all_branch;
  bool els_miniRelIso_all_isLoaded;
  vector<float> els_ptRatio_;
  TBranch *els_ptRatio_branch;
  bool els_ptRatio_isLoaded;
  vector<float> els_ptRel_;
  TBranch *els_ptRel_branch;
  bool els_ptRel_isLoaded;
  vector<float> els_jetBTagCSV_;
  TBranch *els_jetBTagCSV_branch;
  bool els_jetBTagCSV_isLoaded;
  vector<float> mus_ptRatio_;
  TBranch *mus_ptRatio_branch;
  bool mus_ptRatio_isLoaded;
  vector<float> mus_ptRel_;
  TBranch *mus_ptRel_branch;
  bool mus_ptRel_isLoaded;
  vector<float> mus_jetBTagCSV_;
  TBranch *mus_jetBTagCSV_branch;
  bool mus_jetBTagCSV_isLoaded;
  vector<int> els_jetNDauChargedMVASel_;
  TBranch *els_jetNDauChargedMVASel_branch;
  bool els_jetNDauChargedMVASel_isLoaded;
  vector<int> mus_jetNDauChargedMVASel_;
  TBranch *mus_jetNDauChargedMVASel_branch;
  bool mus_jetNDauChargedMVASel_isLoaded;
  ...
  float evt_muegclean_pfmetPhi_;
  TBranch *evt_muegclean_pfmetPhi_branch;
  bool evt_muegclean_pfmetPhi_isLoaded;
  float evt_muegcleanfix_pfmetPhi_;
  TBranch *evt_muegcleanfix_pfmetPhi_branch;
  bool evt_muegcleanfix_pfmetPhi_isLoaded;
  float evt_egclean_pfmetPhi_;
  TBranch *evt_egclean_pfmetPhi_branch;
  bool evt_egclean_pfmetPhi_isLoaded;
  float evt_uncorr_pfmetPhi_;
  TBranch *evt_uncorr_pfmetPhi_branch;
  bool evt_uncorr_pfmetPhi_isLoaded;
 ...
 unsigned int mus_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_MuonLeg_version_;
  ...
  float evt_old_calomet_;
  TBranch *evt_old_calomet_branch;
  bool evt_old_calomet_isLoaded;
  float evt_old_calometPhi_;
  TBranch *evt_old_calometPhi_branch;
  bool evt_old_calometPhi_isLoaded;
  float evt_old_pfmet_;
  TBranch *evt_old_pfmet_branch;
  bool evt_old_pfmet_isLoaded;
  float evt_old_pfmet_ElectronEnDown_;
  TBranch *evt_old_pfmet_ElectronEnDown_branch;
  bool evt_old_pfmet_ElectronEnDown_isLoaded;
  float evt_old_pfmet_ElectronEnUp_;
  TBranch *evt_old_pfmet_ElectronEnUp_branch;
  bool evt_old_pfmet_ElectronEnUp_isLoaded;
  float evt_old_pfmet_JetEnDown_;
  TBranch *evt_old_pfmet_JetEnDown_branch;
  bool evt_old_pfmet_JetEnDown_isLoaded;
  float evt_old_pfmet_JetEnUp_;
  TBranch *evt_old_pfmet_JetEnUp_branch;
  bool evt_old_pfmet_JetEnUp_isLoaded;
  float evt_old_pfmet_JetResDown_;
  TBranch *evt_old_pfmet_JetResDown_branch;
  bool evt_old_pfmet_JetResDown_isLoaded;
  float evt_old_pfmet_JetResUp_;
  TBranch *evt_old_pfmet_JetResUp_branch;
  bool evt_old_pfmet_JetResUp_isLoaded;
  float evt_old_pfmet_MuonEnDown_;
  TBranch *evt_old_pfmet_MuonEnDown_branch;
  bool evt_old_pfmet_MuonEnDown_isLoaded;
  float evt_old_pfmet_MuonEnUp_;
  TBranch *evt_old_pfmet_MuonEnUp_branch;
  bool evt_old_pfmet_MuonEnUp_isLoaded;
  float evt_old_pfmet_PhotonEnDown_;
  TBranch *evt_old_pfmet_PhotonEnDown_branch;
  bool evt_old_pfmet_PhotonEnDown_isLoaded;
  float evt_old_pfmet_PhotonEnUp_;
  TBranch *evt_old_pfmet_PhotonEnUp_branch;
  bool evt_old_pfmet_PhotonEnUp_isLoaded;
  float evt_old_pfmet_TauEnDown_;
  TBranch *evt_old_pfmet_TauEnDown_branch;
  bool evt_old_pfmet_TauEnDown_isLoaded;
  float evt_old_pfmet_TauEnUp_;
  TBranch *evt_old_pfmet_TauEnUp_branch;
  bool evt_old_pfmet_TauEnUp_isLoaded;
  float evt_old_pfmet_UnclusteredEnDown_;
  TBranch *evt_old_pfmet_UnclusteredEnDown_branch;
  bool evt_old_pfmet_UnclusteredEnDown_isLoaded;
  float evt_old_pfmet_UnclusteredEnUp_;
  TBranch *evt_old_pfmet_UnclusteredEnUp_branch;
  bool evt_old_pfmet_UnclusteredEnUp_isLoaded;
  float evt_old_pfmetPhi_;
  TBranch *evt_old_pfmetPhi_branch;
  bool evt_old_pfmetPhi_isLoaded;
  float evt_old_pfmetPhi_ElectronEnDown_;
  TBranch *evt_old_pfmetPhi_ElectronEnDown_branch;
  bool evt_old_pfmetPhi_ElectronEnDown_isLoaded;
  float evt_old_pfmetPhi_ElectronEnUp_;
  TBranch *evt_old_pfmetPhi_ElectronEnUp_branch;
  bool evt_old_pfmetPhi_ElectronEnUp_isLoaded;
  float evt_old_pfmetPhi_JetEnDown_;
  TBranch *evt_old_pfmetPhi_JetEnDown_branch;
  bool evt_old_pfmetPhi_JetEnDown_isLoaded;
  float evt_old_pfmetPhi_JetEnUp_;
  TBranch *evt_old_pfmetPhi_JetEnUp_branch;
  bool evt_old_pfmetPhi_JetEnUp_isLoaded;
  float evt_old_pfmetPhi_JetResDown_;
  TBranch *evt_old_pfmetPhi_JetResDown_branch;
  bool evt_old_pfmetPhi_JetResDown_isLoaded;
  float evt_old_pfmetPhi_JetResUp_;
  TBranch *evt_old_pfmetPhi_JetResUp_branch;
  bool evt_old_pfmetPhi_JetResUp_isLoaded;
  float evt_old_pfmetPhi_MuonEnDown_;
  TBranch *evt_old_pfmetPhi_MuonEnDown_branch;
  bool evt_old_pfmetPhi_MuonEnDown_isLoaded;
  float evt_old_pfmetPhi_MuonEnUp_;
  TBranch *evt_old_pfmetPhi_MuonEnUp_branch;
  bool evt_old_pfmetPhi_MuonEnUp_isLoaded;
  float evt_old_pfmetPhi_PhotonEnDown_;
  TBranch *evt_old_pfmetPhi_PhotonEnDown_branch;
  bool evt_old_pfmetPhi_PhotonEnDown_isLoaded;
  float evt_old_pfmetPhi_PhotonEnUp_;
  TBranch *evt_old_pfmetPhi_PhotonEnUp_branch;
  bool evt_old_pfmetPhi_PhotonEnUp_isLoaded;
  float evt_old_pfmetPhi_TauEnDown_;
  TBranch *evt_old_pfmetPhi_TauEnDown_branch;
  bool evt_old_pfmetPhi_TauEnDown_isLoaded;
  float evt_old_pfmetPhi_TauEnUp_;
  TBranch *evt_old_pfmetPhi_TauEnUp_branch;
  bool evt_old_pfmetPhi_TauEnUp_isLoaded;
  float evt_old_pfmetPhi_UnclusteredEnDown_;
  TBranch *evt_old_pfmetPhi_UnclusteredEnDown_branch;
  bool evt_old_pfmetPhi_UnclusteredEnDown_isLoaded;
  float evt_old_pfmetPhi_UnclusteredEnUp_;
  TBranch *evt_old_pfmetPhi_UnclusteredEnUp_branch;
  bool evt_old_pfmetPhi_UnclusteredEnUp_isLoaded;
  float evt_old_pfmetSig_;
  TBranch *evt_old_pfmetSig_branch;
  bool evt_old_pfmetSig_isLoaded;
  float evt_old_pfmetSignificance_;
  TBranch *evt_old_pfmetSignificance_branch;
  bool evt_old_pfmetSignificance_isLoaded;
  float evt_old_pfmet_raw_;
  TBranch *evt_old_pfmet_raw_branch;
  bool evt_old_pfmet_raw_isLoaded;
  float evt_old_pfmetPhi_raw_;
  TBranch *evt_old_pfmetPhi_raw_branch;
  bool evt_old_pfmetPhi_raw_isLoaded;
  float evt_old_pfsumet_;
  TBranch *evt_old_pfsumet_branch;
  bool evt_old_pfsumet_isLoaded;
  float evt_old_pfsumet_raw_;
  TBranch *evt_old_pfsumet_raw_branch;
  bool evt_old_pfsumet_raw_isLoaded;
...
public:
  ...
  const vector<float> &mus_gfit_ndof_float();
  ...
  const vector<bool> &isotracks_isLostTrack();
  const vector<bool> &isotracks_lepOverlap();
  const vector<float> &isotracks_pfNeutralSum();
  ...
  const vector<int> &isotracks_HitSignature();
  const vector<int> &isotracks_nearestPF_id();
  const vector<float> &isotracks_nearestPF_pt();
  const vector<float> &isotracks_nearestPF_DR();
  const vector<vector<unsigned int> > &isotracks_crossedHcalStatus();
  const vector<vector<unsigned int> > &isotracks_crossedEcalStatus();
  ...
  const vector<float> &ak8jets_deep_bindisc_zbb();
  const vector<float> &ak8jets_deep_bindisc_hbb();
  const vector<float> &ak8jets_deep_bindisc_h4q();
  ...
  const float &genHEPMCweight();
  const float &genHEPMCweight_2016();
  const float &gen_LHEweight_QCDscale_muR1_muF1();
  const float &gen_LHEweight_QCDscale_muR1_muF2();
  const float &gen_LHEweight_QCDscale_muR1_muF0p5();
  const float &gen_LHEweight_QCDscale_muR2_muF1();
  const float &gen_LHEweight_QCDscale_muR2_muF2();
  const float &gen_LHEweight_QCDscale_muR2_muF0p5();
  const float &gen_LHEweight_QCDscale_muR0p5_muF1();
  const float &gen_LHEweight_QCDscale_muR0p5_muF2();
  const float &gen_LHEweight_QCDscale_muR0p5_muF0p5();
  const float &gen_LHEweight_PDFVariation_Up();
  const float &gen_LHEweight_PDFVariation_Dn();
  const float &gen_LHEweight_AsMZ_Up();
  const float &gen_LHEweight_AsMZ_Dn();
  const float &gen_LHEweight_PDFVariation_Up_2016();
  const float &gen_LHEweight_PDFVariation_Dn_2016();
  const float &gen_LHEweight_AsMZ_Up_2016();
  const float &gen_LHEweight_AsMZ_Dn_2016();
  ...
  const vector<float> &els_miniRelIso_all();
  const vector<float> &els_ptRatio();
  const vector<float> &els_ptRel();
  const vector<float> &els_jetBTagCSV();
  const vector<float> &mus_ptRatio();
  const vector<float> &mus_ptRel();
  const vector<float> &mus_jetBTagCSV();
  const vector<int> &els_jetNDauChargedMVASel();
  const vector<int> &mus_jetNDauChargedMVASel();
  ...
  const float &evt_muegclean_pfmetPhi();
  const float &evt_muegcleanfix_pfmetPhi();
  const float &evt_egclean_pfmetPhi();
  const float &evt_uncorr_pfmetPhi();
  ...
  const float &evt_old_calomet();
  const float &evt_old_calometPhi();
  const float &evt_old_pfmet();
  const float &evt_old_pfmet_ElectronEnDown();
  const float &evt_old_pfmet_ElectronEnUp();
  const float &evt_old_pfmet_JetEnDown();
  const float &evt_old_pfmet_JetEnUp();
  const float &evt_old_pfmet_JetResDown();
  const float &evt_old_pfmet_JetResUp();
  const float &evt_old_pfmet_MuonEnDown();
  const float &evt_old_pfmet_MuonEnUp();
  const float &evt_old_pfmet_PhotonEnDown();
  const float &evt_old_pfmet_PhotonEnUp();
  const float &evt_old_pfmet_TauEnDown();
  const float &evt_old_pfmet_TauEnUp();
  const float &evt_old_pfmet_UnclusteredEnDown();
  const float &evt_old_pfmet_UnclusteredEnUp();
  const float &evt_old_pfmetPhi();
  const float &evt_old_pfmetPhi_ElectronEnDown();
  const float &evt_old_pfmetPhi_ElectronEnUp();
  const float &evt_old_pfmetPhi_JetEnDown();
  const float &evt_old_pfmetPhi_JetEnUp();
  const float &evt_old_pfmetPhi_JetResDown();
  const float &evt_old_pfmetPhi_JetResUp();
  const float &evt_old_pfmetPhi_MuonEnDown();
  const float &evt_old_pfmetPhi_MuonEnUp();
  const float &evt_old_pfmetPhi_PhotonEnDown();
  const float &evt_old_pfmetPhi_PhotonEnUp();
  const float &evt_old_pfmetPhi_TauEnDown();
  const float &evt_old_pfmetPhi_TauEnUp();
  const float &evt_old_pfmetPhi_UnclusteredEnDown();
  const float &evt_old_pfmetPhi_UnclusteredEnUp();
  const float &evt_old_pfmetSig();
  const float &evt_old_pfmetSignificance();
  const float &evt_old_pfmet_raw();
  const float &evt_old_pfmetPhi_raw();
  const float &evt_old_pfsumet();
  const float &evt_old_pfsumet_raw();
